...
marketsim_test_cases = [
    MarketsimTestCase(
        ...
        group='basic',
        inputs=dict(
            orders_file=os.path.join(path, 'orders-01.csv'),
            start_val=1000000,
            commission=0.,
            impact=0.
        ),
    ...
    MarketsimTestCase(
        ...
        group='basic',
        inputs=dict(
            orders_file=os.path.join(path, 'orders-02.csv'),
            start_val=1000000,
            commission=0.,
            impact=0.
        ),
    ...
    MarketsimTestCase(
        ...
        group='basic',
        inputs=dict(
            orders_file=os.path.join(path, 'orders-03.csv'),
            start_val=1000000,
            commission=0.,
            impact=0.
        ),
    ...
    MarketsimTestCase(
        ...
        group='basic',
        inputs=dict(
            orders_file=os.path.join(path, 'orders-04.csv'),
            start_val=1000000,
            commission=0.,
            impact=0.
        ),
    ...
    MarketsimTestCase(
        ...
        group='basic',
        inputs=dict(
            orders_file=os.path.join(path, 'orders-05.csv'),
            start_val=1000000,
            commission=0.,
            impact=0.
        ),
    ...
    MarketsimTestCase(
        ...
        group='basic',
        inputs=dict(
            orders_file=os.path.join(path, 'orders-06.csv'),
            start_val=1000000,
            commission=0.,
            impact=0.
        ),
    ...
    MarketsimTestCase(
        ...
        group='basic',
        inputs=dict(
            orders_file=os.path.join(path, 'orders-07-modified.csv'),
            start_val=1000000,
            commission=0.,
            impact=0.
        ),
    ...
    MarketsimTestCase(
        ...
        group='basic',
        inputs=dict(
            orders_file=os.path.join(path, 'orders-08-modified.csv'),
            start_val=1000000,
            commission=0.,
            impact=0.
        ),
    ...
    MarketsimTestCase(
        ...
        group='basic',
        inputs=dict(
            orders_file=os.path.join(path, 'orders-09-modified.csv'),
            start_val=1000000,
            commission=0.,
            impact=0.
        ),
    ...
    MarketsimTestCase(
        ...
        group='basic',
        inputs=dict(
            orders_file=os.path.join(path, 'orders-10-modified.csv'),
            start_val=1000000,
            commission=0.,
            impact=0.
        ),
    ...
    MarketsimTestCase(
        ...
        group='leverage',
        inputs=dict(
            orders_file=os.path.join(path, 'orders-11-modified.csv'),
            start_val=1000000,
            commission=0.,
            impact=0.
        ),
    ...
    MarketsimTestCase(
        ...
        group='leverage',
        inputs=dict(
            orders_file=os.path.join(path, 'orders-12-modified.csv'),
            start_val=1000000,
            commission=0.,
            impact=0.
        ),
    ...
    MarketsimTestCase(
        ...
        group='leverage',
        inputs=dict(
            orders_file=os.path.join(path, 'orders-leverage-1.csv'),
            start_val=1000000,
            commission=0.,
            impact=0.
        ),
    ...
    MarketsimTestCase(
        ...
        group='leverage',
        inputs=dict(
            orders_file=os.path.join(path, 'orders-leverage-2.csv'),
            start_val=1000000,
            commission=0.,
            impact=0.
        ),
    ...
    MarketsimTestCase(
        ...
        group='leverage',
        inputs=dict(
            orders_file=os.path.join(path, 'orders-leverage-3.csv'),
            start_val=1000000,
            commission=0.,
            impact=0.
        ),
